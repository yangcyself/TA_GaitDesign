...
namespace LeftImpact
{
  ...
  inline void dxDiscreteMapLeftImpact(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var1,const Eigen::VectorXd &var2,const Eigen::VectorXd &var3,const Eigen::VectorXd &var4)
  {
    // Check
    // - Inputs
    ...
    dxDiscreteMapLeftImpact_raw(p_output1.data(), var1.data(),var2.data(),var3.data(),var4.data());
    }
